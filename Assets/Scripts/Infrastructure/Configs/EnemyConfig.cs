...
namespace Asteroids.Infrastructure
{
    ...
    public class EnemyConfig
    {
        ...
        public float ufoSpawnDelay = 5f;
        public float ufoSpawnIntervalMultiplier = 2f;
        
        public float asteroidMediumSpeed = 4f;
        public float asteroidSmallSpeed = 6f;
        public int asteroidSplitCount = 2;
    }
}